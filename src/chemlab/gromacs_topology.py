...
def setNonbondedInteractions(system, gt, vl, lj_cutoff=None, tab_cutoff=None, tables=None, cr_observs=None):  #NOQA
    ...
    if all_type_pairs - defined_types:
        raise RuntimeError('Not defined types {} '.format(all_type_pairs - defined_types))
...
def set_bonded_interactions(system, gt, name='bonds'):
    ...
    for func in bonds_by_func:
        ...
        for params, b_list in bonds_by_func[func].items():
            ...
            interaction = interaction_class(system, fpl, potential_class(**convert_params(func, params[1:])))
...
def setDihedralInteractions(system, gt, name='dihedrals'):
    ...
    for func in dihedrals_by_func:
        ...
        for params, b_list in dihedrals_by_func[func].items():
            ...
            interaction = interaction_class(system, fql, potential_class(**convert_params(func, params[1:])))
